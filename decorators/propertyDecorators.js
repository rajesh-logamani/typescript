...
function propertyDecorator(target, context) {
    console.log('Property decorator');
    console.log(target);
    console.log(context.name);
}
let PropertyDecoratorExample = (() => {
    var _a;
    let _property_decorators;
    let _property_initializers = [];
    let _property_extraInitializers = [];
    return _a = class PropertyDecoratorExample {
            constructor(message) {
                this.property = __runInitializers(this, _property_initializers, void 0);
                this.hello = __runInitializers(this, _property_extraInitializers);
                this.hello = message;
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _property_decorators = [propertyDecorator];
